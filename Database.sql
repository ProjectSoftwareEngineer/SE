...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2024 at 02:02 AM
...
('root', '[{\"db\":\"shopping_cart\",\"table\":\"tbl_member\"},{\"db\":\"shopping_cart\",\"table\":\"tbl_type\"},{\"db\":\"shopping_cart\",\"table\":\"tbl_product\"},{\"db\":\"pro\",\"table\":\"tbl_type\"},{\"db\":\"pro\",\"table\":\"tbl_product\"},{\"db\":\"pro\",\"table\":\"tbl_member\"},{\"db\":\"pro\",\"table\":\"tbl_admin\"}]');
...
('root', 'pro', 'tbl_admin', '{\"sorted_col\":\"`tbl_admin`.`a_user` DESC\"}', '2024-02-03 22:41:40');
...
('root', '2024-02-07 01:02:13', '{\"Console\\/Mode\":\"collapse\"}');
...
(1, 'tonkailcom', 'Tonkailcom123', 'Tonkailcom', '2024-02-03 14:01:03'),
(2, 'admin', '123', 'admin1', '2024-02-03 22:17:17');
...
(1, 'Set Spectrum', 2, 'Set Skin Spectrum ไม่รวมบัดดี้ ✅\r\nสกินปืนนับสีที่ปลดล็อก ✅\r\nสุ่มเติม battle pass แล้ว ✅\r\nเอเจนเกือบครบ บางรหัสครบ ✅\r\nสุ่มพ้อยคงเหลือ ✅\r\nรับประกันไม่โดนแบน ✅\r\nรหัสอาจมีคนเข้าซ้อนหรือถูกเปลี่ยนแต่ถ้าโชคดีก็ได้เล่นยาวๆ ⚠️\r\nเปลี่ยนรหัสไม่ได้ ⛔\r\nไม่รับประกัน ⛔\r\nหมายเหตุ : เข้าไม่ได้สามารถเคลมได้ภายใน 10 นาทีหลังซื้อ ⚠️             ', 'p_img118975365720240203_210405.jpg', '2024-02-03 14:04:05'),
(4, '1-50 SKIN RANDOM', 1, 'สุ่มสกิน 15-100 skin\r\n-ประกัน 1 ชั่วโมง', 'p_img70875732920240204_104915.jpg', '2024-02-04 03:49:15'),
(5, 'การันตีแรงค์ Iron', 3, '-ประกัน 1 ชั่วโมง', 'p_img187466036220240204_105156.png', '2024-02-04 03:51:56'),
(6, 'การันตีแรงค์ Bronze', 3, '-ประกัน 1 ชั่วโมง', 'p_img63700491820240204_105231.png', '2024-02-04 03:52:31'),
(7, 'การันตีแรงค์ Silver', 3, '-ประกัน 1 ชั่วโมง', 'p_img18143217020240204_105257.png', '2024-02-04 03:52:57'),
(8, 'การันตีแรงค์ Gold', 3, '-ประกัน 1 ชั่วโมง', 'p_img49900771520240204_105327.png', '2024-02-04 03:53:27');
