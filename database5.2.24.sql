...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2024 at 02:13 AM
...
('root', '[{\"db\":\"shopping_cart\",\"table\":\"tbl_member\"},{\"db\":\"shopping_cart\",\"table\":\"tbl_product\"},{\"db\":\"shopping_cart\",\"table\":\"tbl_type\"},{\"db\":\"pro\",\"table\":\"tbl_type\"},{\"db\":\"pro\",\"table\":\"tbl_product\"},{\"db\":\"pro\",\"table\":\"tbl_member\"},{\"db\":\"pro\",\"table\":\"tbl_admin\"}]');
...
('root', '2024-02-05 00:12:23', '{\"Console\\/Mode\":\"collapse\"}');
...
(5, 'testmember', '123', 'member', 'mem', 'mem@gmail.com', '0123456789', 'TestMember', '98160225220240205_071059.png', '2024-02-05 00:10:59'),
(6, 'testmember2', '123', 'member', 'TK', 'mem2@gmail.com', '0123456789', 'TestMember2', '117725392920240205_071214.png', '2024-02-05 00:12:14');
...
(3, 'เค้กบราวนี่หน้านิ่ม', 3, 'มีลักษณะเนื้อฉ่ำแน่น รสชาติเข้มข้น มีสัดส่วนของช็อกโกแลตสูงและสัดส่วนของแป้งจะน้อยกว่าแบบอื่น หน้ามีความกรอบ หรืออาจเรียกได้ว่า บราวนี่หน้ากรอบ', '66496319120210626_234635.jpg', 100, '10', 'อัน', 4, '2021-06-26 16:46:35'),
